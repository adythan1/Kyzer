...
(function($) {
  ...
  $.fn.mfnMenu = function(options) {
    ...
    var init = function() {
      ...
      $('li:has(ul)', menu).attr('role','submenu').append('<a class="menu-toggle" href="#" role="menuitem" aria-label="'+ mfn.accessibility.translation.toggleSubmenu +'"></a>').on('click', '.menu-toggle', function(e){
